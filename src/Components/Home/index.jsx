...
<h3 className='fw-bold'>Trending<br/> Movies<br/>To watch right now  </h3>
...
<div>
<div className='brdr w-25'></div>
<h3 className='fw-bold'>Trending<br/> Actors <br/>To view right now  </h3>
...
<div>
<div className='brdr w-25'></div>
<h3 className='fw-bold'>Trending<br/> Tv<br/>To view right now  </h3>
